...
if (!isset($_SESSION['name'])) {
    ...
    <div id="prod-form">
        ...
        <form action="./updateProduct.php" class="form" method="post">

            <input type="text" class="input-type" name="prod_name" id="prod_name" placeholder="Product Name">
            <select name="cat_id" id="" class="input-type">
                <?php
                $i = 0;
                ...
                while ($data = mysqli_fetch_assoc($res)) {
                    $cat_id = $data['cat_id'];
                    ?>
                    <option value="<?php echo $cat_id ?>"><?php echo $data['cat_name']; ?></option>
                    <?php
                }
                ?>
            </select>
            <select name="sup_id" id="" class="input-type">
                ...
                while ($data = mysqli_fetch_assoc($res)) {
                    $sup_id = $data['sup_id'];
                    ?>
                    <option value="<?php echo $sup_id ?>"><?php echo $data['sup_name']; ?></option>
                    <?php
                }
                ?>
            </select>
            <input type="number" name="rate" placeholder="Rate" class="input-type" id="rate">
            ...
            <div class=" col-10 sec-2">
                ...
                <div class="search-bar-outer">
                    ...
                    <form action="" class="search-bar">
                        ...
                        <input name="search" type="text" class="search-bar-1" placeholder="Search">
                ...
                <table id="customers">
                    <tr>
                        ...
                        <th style="text-align:center; padding: 20px;">Rate</th>
                    ...
                    if (isset($_GET['search'])) {
                        $src = $_GET['search'];
                        $res = mysqli_query($conn, "select * from products WHERE prod_name LIKE '%$src%'");
                    } else {
                    ...
                    while ($data = mysqli_fetch_assoc($res)) {
                        ...
                        $sqli2 = mysqli_query($conn, "SELECT * from cat where cat_id = '$cat_id'");
                        ?>
                        <tr>
                            ...
                            <td>
                                <?php echo mysqli_fetch_assoc($sqli)['sup_name']; ?>
                            </td>
                            <td>
                                <?php echo mysqli_fetch_assoc($sqli2)['cat_name']; ?>
                            </td>
                            <td>
                                <?php echo $data["prod_count"]; ?>
                            </td>
                            ...
                            <td class="btn-center">
                                <button class="update-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="upd-btn"
                                        id="update-btn-<?php echo $prod_id ?>" width="18" height="18" fill="currentColor"
                            ...
                            <td class="btn-center"><a href="./deleteProd.php?id=<?php echo $prod_id ?>"><button
                                        class="delete-btn">
