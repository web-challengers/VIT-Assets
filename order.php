    ...
    <body>
        ...
        <div id="order-form">
            ...
            <form action="" class="form">
                ...
                <input type="text" class="input-type" name="item_count" id="item_count" placeholder="Item Count">
                <input type="text" class="input-type" name="amount" id="amount" placeholder="Amount">
...
<table id="customers">
    ...
    <tr>
        <td><?php echo ++$i; ?></td>
      <td><?php echo mysqli_fetch_assoc($sqli)['prod_name']; ?></td>
